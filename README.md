...
- **Unsupported aiming develops recoverable native weapon sway.** Crouching lasts longer before fatigue sets in, while prone aiming or held breath provides support. The separate **Player Stamina** slider scales native sprint, breath-hold, and jump endurance from 0.5x to 3x, with 1x preserving the base game. The enabled-by-default **Stamina Bar** toggle shows the local player's remaining native stamina while alive and on foot.
